...
const routes: Routes = [
  ...
  { path: 'marketing', loadChildren: './pages/marketing/marketing.module#MarketingPageModule' },
  ...
  { path: 'promocion', loadChildren: './pages/promocion/promocion.module#PromocionPageModule' },
  { path: 'trazabilidad', loadChildren: './pages/trazabilidad/trazabilidad.module#TrazabilidadPageModule' },
